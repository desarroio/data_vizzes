...
::: {.bajada}
Solo 406 mujeres tienen calles con su nombre en Lima y Callao. ¿Dónde están esas calles? ¿quiénes son esas mujeres en nuestra historia? ¿qué roles representan? Acompáñanos en este recorrido por la ciudad y las mujeres que nombran sus calles.
:::
...
Este mapa fue es un trabajo del equipo de [desarro.io](desaro.io). La idea y propototipo en python es de [Carla Solis](https://github.com/ccsuehara). El desarrollo web es de [Gonzalo Talavera](https://github.com/gtalavera). La historia, redacción de los textos y factchecking son de Daniela Velit, Ioanna Gallo y Gonzalo Talavera. Los nombres de calles son de @openstreetmap 🔎, el mapa se hizo con @leafletJS 🍃 y tiles 🗺️ de @carto.
